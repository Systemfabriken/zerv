//#####################################################################################################################
//#                                                                                                                   #
//#                              Copyright (C) 2022 DevPort Ost AB, all rights reserved.                              #
...
/**
 * @brief Get the number of system clock ticks since the start_ticks and updates start_ticks to the current time.
 * 
 * @param start_ticks Pointer to the start time in ticks. Will be updated to the current time in ticks.
 * 
 * @return The number of system clock ticks since the start_ticks.
 */
