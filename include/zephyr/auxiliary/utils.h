...
/**
 * @brief Defines the format for printing floating-point numbers as integers with two decimal places.
 */
 ...
 * 
 * @return Returns three components: the sign as a char ('-' or ' '), the whole number, and the two-decimal fraction.
 * 
 * @example 
...
/**
 * @brief Defines the format for printing floating-point numbers as integers with four decimal places.
 */
 ...
 * @param val The floating-point number to be converted.
 * 
 * @return Returns three components: the sign as a char ('-' or ' '), the whole number, and the four-decimal fraction.
 * 
 * @example 
